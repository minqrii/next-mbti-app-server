...
module.exports = (io, socket) => {
    ...
    socket.on('getPushSound', socketMiddleware(
        socketValidate(pushNotificationValidation.getPushSound),
        pushNotificationController.getPushSound
    )(io, socket))

    socket.on('updatePushSound', socketMiddleware(
        socketValidate(pushNotificationValidation.updatePushSound),
        pushNotificationController.updatePushSound
    )(io, socket))
};
